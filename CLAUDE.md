...
## Структуры описаний контента клуба

### Тренировка короткая (до 20 мин) — название: прилагательное
```
ТРЕНИРОВКА: [Прилагательное]
[Описание — 1-2 предложения, что делаем, когда хорошо делать]
...
### Тренировка длинная (20+ мин) — название: описательное
```
ТРЕНИРОВКА: [Описательное название, напр. «Растяжка спины»]
[Описание]
...
### Хореография / Рутина
```
ХОРЕОГРАФИЯ: «[Название песни]» — [Исполнитель]
[Описание — про что песня, что делаем на уроке]

Часть X | Длительность: X минут

Результат тренировки:
✔️ [результат]

⭐ Задание: выучи фрагмент и сними видео — как получается. Отправь в чат домашних заданий
Получи +50 баллов на свой счёт
```
...
```
ЭФИР: «[Тема]»
[Имя спикера] — [специальность]. [Описание темы — что разбираем, 1-2 предложения]. Проходим X этапа: [этап 1], [этап 2], [этап 3].

Длительность: X мин

После эфира ты:
✔️ Поймёшь / Увидишь / Узнаешь [результат]
✔️ ...

⭐ Задание: напиши в чат обратную связь по эфиру
Получи +50 баллов на свой счёт

Вопросы и связь: @[ник спикера]
```

### Общие правила стиля (речь Элины)
- Короткие предложения, живой разговорный тон
- Без ИИ-клише: не «раскрой себя», «стань лучшей версией», «трансформация»
- Без конструкции «когда ты / когда женщина»
- Без «коротко, по делу, без воды» и подобных
- Результаты: конкретные, телесные, без пафоса
- Задание для эфира: «напиши обратную связь», не видео
- Всегда указывать контакт спикера если есть
